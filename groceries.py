...
for product in products:
    product["department"]
department = ["snacks","pantry","beverages","frozen","pantry","personal care","beverages","frozen","dairy eggs","beverages",
...
for item in unique_department:
    print('the %s department has %d products' %(item,department.count(item)))
